...
const skills = [
  ...
  { name: 'Tailwind', icon: faCodeBranch, link: 'https://tailwindcss.com/' },
      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {skills.map((skill, index) => (
            <a key={index} href={skill.link} target="_blank" rel="noopener noreferrer" className="transform transition-transform duration-300 hover:scale-105">
              <div className="bg-yellow-50 rounded-lg shadow-md p-6 flex flex-col items-center hover:bg-yellow-100">
                <FontAwesomeIcon icon={skill.icon} size="2x" className="text-yellow-500 mb-4" />
